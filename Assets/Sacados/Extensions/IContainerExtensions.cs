namespace Sacados {
    ...
    public static class IContainerExtensions {
        ...
        /// </summary>
        /// <param name="container">The <see cref="IStackContainer"/> to which the <see cref="ItemStack"/> might be given</param>
        ...
        /// </summary>
        /// <param name="container">The <see cref="IStackContainer"/> from which the <see cref="ItemStack"/> might be taken</param>
